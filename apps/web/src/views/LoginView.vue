    ...
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        <div class="inline-block mb-4">
          <div
            class="w-20 h-20 bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center mx-auto shadow-2xl transform hover:scale-110 transition-transform">
        ...
        <p class="mt-2 text-center text-sm">
          <a href="/"
            class="font-semibold text-blue-600 hover:text-purple-600 transition-colors inline-flex items-center">
      ...
      <div class="bg-white py-10 px-6 shadow-2xl rounded-2xl sm:px-12 border border-gray-100">
        ...
        <form v-if="mode !== 'forgot'" class="space-y-6" @submit.prevent="handleSubmit">
          ...
          <div v-if="mode === 'register'">
            ...
            <input id="name" v-model="formData.name" type="text" autocomplete="name"
          ...
          <div v-if="mode === 'register'">
            ...
            <input id="passwordConfirm" v-model="formData.passwordConfirm" type="password" autocomplete="new-password"
              required
              class="appearance-none block w-full px-4 py-3 border-2 border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all sm:text-sm hover:border-gray-400"
        ...
        <form v-if="mode === 'forgot'" class="space-y-6" @submit.prevent="handleForgotPassword">
          ...
          <div>
            ...
            <input id="forgot-email" v-model="formData.email" type="email" autocomplete="email" required
              class="appearance-none block w-full px-4 py-3 border-2 border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all sm:text-sm hover:border-gray-400"
              placeholder="seu@email.com" />
          </div>
